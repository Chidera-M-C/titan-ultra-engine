...
const RatioIcon = ({ ratio }) => {
  switch (ratio) {
    ...
    case '5:4':
      return <svg width="12" height="10" viewBox="0 0 12 10" style={{ flexShrink: 0 }}><rect width="12" height="10" rx="1" fill="currentColor" /></svg>;
    case '9:16':
...
export default function AspectRatioDropdown({ value, onChange }) {
  ...
  return (
    <div className="aspect-dropdown" ref={dropdownRef}>
      <div className="aspect-pill" onClick={() => setIsOpen(!isOpen)}>
