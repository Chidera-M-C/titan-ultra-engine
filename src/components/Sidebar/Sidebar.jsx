...
export default function Sidebar({ activeTab, onNavigate, credits, userId, isOpen, onPromptLoad, onNegativePromptLoad, currentPrompt, currentNegativePrompt, onTopUpClick }) {
        ...
        {user ? (
          <div className="user-profile" ref={profileRef}>
            <div className="user-info">
              {profile?.avatar_url ? (
                <img src={profile.avatar_url} alt="Profile" className="avatar avatar-image" />
              ) : (
