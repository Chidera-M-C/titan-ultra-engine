          ...
          <button onClick={loginWithGoogle} className="google-login-btn">
            ...
            >
              <g fill="none" fillRule="evenodd">
                <path
                  d="M17.64 9.2045c0-.6381-.0573-1.2518-.1636-1.8409H9v3.4818h4.8445c-.2086 1.125-.8427 2.0782-1.7959 2.7164v2.2581h2.9086c1.7018-1.5668 2.6827-3.8745 2.6827-6.6154z"
                  fill="#4285F4"
                />
                <path
                  d="M9 18c2.43 0 4.4673-.8064 5.9564-2.1805l-2.9086-2.2581c-.8059.54-1.8373.8591-3.0477.8591-2.3445 0-4.3282-1.5831-5.036-3.7104H.9573v2.3318C2.4382 15.9832 5.4818 18 9 18z"
                  fill="#34A853"
                />
                <path
                  d="M3.964 10.71c-.1818-.54-.2864-1.1168-.2864-1.71s.1046-1.17.2864-1.71V4.9582H.9573C.3473 6.1736 0 7.5477 0 9s.3473 2.8264.9573 4.0418l3.0068-2.3318z"
                  fill="#FBBC05"
                />
                <path
                  d="M9 3.5795c1.3214 0 2.5077.4541 3.4405 1.3464l2.5818-2.5818C13.4636.9627 11.4264 0 9 0 5.4818 0 2.4382 2.0168.9573 4.9582L3.964 7.29C4.6718 5.1627 6.6555 3.5795 9 3.5795z"
                  fill="#EA4335"
                />
              </g>
            </svg>
